...
git clone https://github.com/YOUR\_USERNAME/ticket-booking-system.git
...
g++ -std=c++11 -o ticket\_system src/main.cpp
...
g++ -std=c++11 -o ticket\_system.exe src/main.cpp
